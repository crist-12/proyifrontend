...
import { fetchMessageData,deleteFetch } from '../../store/reducers/swot/actions';
...
const Lista = () => {
    ...
    const itemsUI = items.map((o,i)=>{
        return (<ListItem handlerDelete={()=>{del(o._id)}} key={i}>{o.title} {o.message} {o.to}</ListItem>);
    });
